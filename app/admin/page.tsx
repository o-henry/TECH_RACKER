        ...
        <div className="page-shell">
          ...
          <section className="admin-section" aria-labelledby="pipelineTitle">
            ...
            <div className="pipeline-grid" id="pipelineGrid">
              <article><span className="mono">01 / COLLECT</span><h3>원출처·관심 신호 수집</h3><p>Google Trends KR·US와 검토된 RSS는 10분, SEC는 30분, 임상은 4시간, 논문은 1일 간격입니다. Trends는 관심 신호일 뿐 기술 진전의 근거로 쓰지 않습니다.</p><strong className="mono" data-pipeline-status="collect">UNKNOWN</strong></article>
