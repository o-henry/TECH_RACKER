...
window.TECHNOLOGIES.push(
  ...
  },
  {
    ...
    "name": "AI 단백질 결합체 설계",
    "nameEn": "AI protein binder design",
    "category": "AI·생명과학",
    "status": "실험 검증 연구",
    "statusKey": "pilot",
    "trajectory": "advance",
    "trajectoryLabel": "다중 표적 실험 검증",
    "verifiedAt": "2026-08-21",
    "summary": "표적 단백질의 구조를 입력으로 받아 결합할 새 단백질 서열을 생성하고 실험으로 선별하는 기술이다. 구조 예측을 넘어 새 결합체를 설계하지만, 결합 성공이 세포 기능·안전성·치료 효과를 곧바로 입증하지는 않는다.",
    "currentState": "AlphaProteo가 7개 표적에서 실험 결합체를 만들었으나 TNF-α 표적에는 성공하지 못한 연구 검증 단계",
    "access": "제한 연구 협력·논문·일부 공개 구조 자료",
    "latest": { "date": "2024-09-05", "title": "AlphaProteo가 7개 표적의 새 결합체를 실험 검증", "text": "Google DeepMind는 기존 최선 대비 3배에서 300배 높은 결합 친화도를 보고했지만, 난도가 높은 TNF-α에는 설계가 성공하지 않았다고 함께 밝혔다.", "source": "Google DeepMind", "url": "https://deepmind.google/blog/alphaproteo-generates-novel-proteins-for-biology-and-health-research/" },
    "next": { "date": "지속 확인", "text": "독립 실험실 재현, 세포 기능·면역원성·약동학 검증, 실패 표적군에서의 일반화 성과" },
    "constraints": ["구조상 결합과 생물학적 기능 사이의 간극", "표적별 데이터 편향과 난도 차이", "면역원성·안정성·발현·제조 가능성", "독립 재현과 생체 내 효능 자료 부족"],
    "unknowns": ["비공개 표적에서의 성공률", "설계 후보당 실험 비용과 실패율", "치료 후보로 전환되는 비율"],
    "dimensions": [
      { "label": "설계", "state": "confirmed", "stateLabel": "생성", "value": "구조 기반 새 결합체 서열 생성", "note": "제공사 연구 결과" },
      { "label": "결합", "state": "confirmed", "stateLabel": "실험 확인", "value": "7개 표적에서 결합체 검증", "note": "TNF-α 실패 포함" },
      { "label": "세포 기능", "state": "progress", "stateLabel": "제한 확인", "value": "일부 표적 기능 효과", "note": "표적별 차이" },
      { "label": "생체 내 효능", "state": "unknown", "stateLabel": "미확인", "value": "질환 모델·인체 효능", "note": "결합 결과와 구분" },
      { "label": "제조", "state": "unknown", "stateLabel": "미확인", "value": "안정성·발현·대량생산", "note": "후속 개발 필요" }
    ],
    "facts": [
      { "value": "7 TARGETS", "label": "실험 결합체가 보고된 표적 수", "note": "2024-09-05 DeepMind" },
      { "value": "3–300×", "label": "기존 최선 대비 결합 친화도 제공사 보고", "note": "표적별 수치" },
      { "value": "1 FAILURE", "label": "TNF-α 설계 실패 공개", "note": "일반화 한계" }
    ],
    "timeline": [
      { "date": "2024-05-08", "title": "AlphaFold 3 상호작용 예측 논문 공개", "text": "단백질과 다른 생체분자의 상호작용 구조 예측 기반이 공개됐다.", "kind": "논문", "url": "https://www.nature.com/articles/s41586-024-07487-w", "source": "Nature" },
      { "date": "2024-09-05", "title": "AlphaProteo 실험 결과 공개", "text": "7개 표적의 신규 결합체와 한 개 실패 표적이 함께 보고됐다.", "kind": "실험 검증", "url": "https://deepmind.google/blog/alphaproteo-generates-novel-proteins-for-biology-and-health-research/", "source": "Google DeepMind" }
    ],
    "sources": [
      { "type": "동료평가 논문", "publisher": "Nature", "title": "Accurate structure prediction of biomolecular interactions with AlphaFold 3", "date": "2024-05-08", "url": "https://www.nature.com/articles/s41586-024-07487-w" },
      { "type": "연구기관 발표", "publisher": "Google DeepMind", "title": "AlphaProteo generates novel proteins for biology and health research", "date": "2024-09-05", "url": "https://deepmind.google/blog/alphaproteo-generates-novel-proteins-for-biology-and-health-research/" }
    ]
  },
  {
    "id": "ai-materials-discovery",
    "name": "AI 기반 무기 결정 소재 발견",
    "nameEn": "AI-guided inorganic materials discovery",
    "category": "AI·과학",
    "status": "자동 합성 검증",
    "statusKey": "pilot",
    "trajectory": "advance",
    "trajectoryLabel": "계산 후보에서 로봇 합성으로 연결",
    "verifiedAt": "2026-08-21",
    "summary": "그래프 신경망으로 안정한 결정 후보를 대규모 탐색하고 로봇 실험실이 합성 조건을 선택·실행하는 기술이다. 후보 공간을 크게 넓혔지만 계산 안정성, 실제 합성 가능성, 물성, 공정 경제성은 서로 다른 검증 단계다.",
    "currentState": "GNoME가 220만 개 후보와 38만 개 안정 후보를 보고했고 A-Lab이 17일 동안 57개 표적 중 36개를 합성한 연구 자동화 단계",
    "access": "공개 데이터·논문·연구 자동화 플랫폼",
    "latest": { "date": "2026-01-19", "title": "A-Lab 논문의 정정 공지가 게재", "text": "원 논문의 일부 분석이 정정됐으므로 자동 합성 성과는 정정된 논문과 보조자료를 기준으로 해석해야 한다.", "source": "Nature", "url": "https://www.nature.com/articles/s41586-023-06734-w" },
    "next": { "date": "지속 확인", "text": "독립 재현 합성률, 목표 물성 측정, 파일럿 공정 수율과 후보당 시간·비용" },
    "constraints": ["계산 안정성과 실제 합성 가능성의 차이", "합성돼도 목표 물성을 만족하지 않을 위험", "실험 장비·전구체·문헌 데이터 편향", "그램·킬로그램 규모 공정으로의 전환"],
    "unknowns": ["독립 연구실의 전체 후보 재현률", "목표 성능까지 도달하는 후보 비율", "산업 공정에서의 비용·수율"],
    "dimensions": [
      { "label": "후보 생성", "state": "confirmed", "stateLabel": "대규모", "value": "220만 개 신규 결정 후보 보고", "note": "GNoME 연구" },
      { "label": "안정성", "state": "confirmed", "stateLabel": "계산 예측", "value": "38만 개 안정 후보 보고", "note": "실험 안정성과 구분" },
      { "label": "합성", "state": "confirmed", "stateLabel": "로봇 실증", "value": "57개 중 36개 성공", "note": "A-Lab 범위" },
      { "label": "물성", "state": "unknown", "stateLabel": "미확인", "value": "용도별 성능 분포", "note": "후보별 검증 필요" },
      { "label": "양산", "state": "unknown", "stateLabel": "미확인", "value": "산업 규모 공정성", "note": "연구 합성과 구분" }
    ],
    "facts": [
      { "value": "2.2M", "label": "GNoME 신규 결정 후보", "note": "2023 Nature·DeepMind" },
      { "value": "380K", "label": "계산상 안정 후보", "note": "실험 검증 수와 구분" },
      { "value": "36 / 57", "label": "A-Lab 합성 성공 표적", "note": "17일·353회 실험" }
    ],
    "timeline": [
      { "date": "2023-11-29", "title": "GNoME와 A-Lab 논문 동시 공개", "text": "대규모 결정 후보 생성과 폐쇄루프 로봇 합성 결과가 각각 공개됐다.", "kind": "논문", "url": "https://deepmind.google/blog/millions-of-new-materials-discovered-with-deep-learning/", "source": "Google DeepMind / Nature" },
      { "date": "2026-01-19", "title": "A-Lab 논문 정정", "text": "정정된 본문과 보조자료를 기준으로 결과를 재확인해야 한다.", "kind": "정정", "url": "https://www.nature.com/articles/s41586-023-06734-w", "source": "Nature" }
    ],
    "sources": [
      { "type": "동료평가 논문", "publisher": "Nature", "title": "Scaling deep learning for materials discovery", "date": "2023-11-29", "url": "https://www.nature.com/articles/s41586-023-06735-9" },
      { "type": "동료평가 논문", "publisher": "Nature", "title": "An autonomous laboratory for the accelerated synthesis of novel materials", "date": "2023-11-29 · 정정 2026-01-19", "url": "https://www.nature.com/articles/s41586-023-06734-w" },
      { "type": "연구기관 설명", "publisher": "Google DeepMind", "title": "Millions of new materials discovered with deep learning", "date": "2023-11-29", "url": "https://deepmind.google/blog/millions-of-new-materials-discovered-with-deep-learning/" }
    ]
  },
  {
    "id": "car-t-autoimmune",
    "name": "자가면역질환 CAR-T 세포치료",
    "nameEn": "CAR-T cell therapy for autoimmune disease",
    "category": "의료·세포치료",
    "status": "초기 임상",
    "statusKey": "clinical",
    "trajectory": "advance",
    "trajectoryLabel": "자가·동종·생체 내 방식 병행 탐색",
    "verifiedAt": "2026-08-21",
    "summary": "B세포를 제거하거나 면역계를 재설정하기 위해 CAR-T를 중증 자가면역질환에 적용하는 기술이다. 사례·초기 임상 신호가 있지만 소규모, 환자 선택, 전처치 독성, 재발과 장기 안전성이 핵심 제한이다.",
    "currentState": "자가 CAR-T와 BCMA CAR-T 임상이 진행 중이며 2025~2026년에는 mRNA·circRNA 기반 생체 내 CAR-T 초기 임상도 등록된 단계",
    "access": "임상시험 참여자 중심",
    "latest": { "date": "2026-05-06", "title": "BCMA CAR-T 자가면역 1상 시험이 모집 상태로 갱신", "text": "NCT07085676은 최대 120명을 대상으로 안전성과 초기 활성을 평가한다. 등록 목표는 결과가 아니며 효능 확정으로 해석할 수 없다.", "source": "ClinicalTrials.gov", "url": "https://clinicaltrials.gov/study/NCT07085676" },
    "next": { "date": "2026년→", "text": "질환별 관해 지속기간, B세포 재구성, 중증 이상반응, 대조군 비교와 생체 내 방식의 오프타깃 자료" },
    "constraints": ["전처치 화학요법과 사이토카인·신경 독성", "질환별 이질성과 환자 선택", "세포 제조 시간·비용·접근성", "장기관해·재발·면역 재구성 자료 부족"],
    "unknowns": ["표준치료 대비 순편익", "질환별 최적 표적과 투여 방식", "생체 내 CAR-T의 분포·오프타깃·지속성"],
    "dimensions": [
      { "label": "자가 CAR-T", "state": "progress", "stateLabel": "초기 임상", "value": "CD19·BCMA 표적 시험", "note": "질환별 소규모" },
      { "label": "생체 내 CAR-T", "state": "progress", "stateLabel": "초기 1상", "value": "mRNA·circRNA 전달", "note": "등록·초기 단계" },
      { "label": "관해 지속", "state": "unknown", "stateLabel": "미확인", "value": "장기 무치료 관해", "note": "추적기간 제한" },
      { "label": "안전성", "state": "progress", "stateLabel": "추적 중", "value": "CRS·신경독성·감염", "note": "장기 자료 필요" },
      { "label": "비교효과", "state": "unknown", "stateLabel": "미확인", "value": "대조군 대비 효능", "note": "무작위 자료 부족" }
    ],
    "facts": [
      { "value": "PHASE 1", "label": "주요 추적 시험 단계", "note": "ClinicalTrials.gov" },
      { "value": "UP TO 120", "label": "NCT07085676 등록 목표", "note": "결과 수가 아님" },
      { "value": "3 MODALITIES", "label": "자가·mRNA·circRNA 방식 추적", "note": "각각 별도 위험" }
    ],
    "timeline": [
      { "date": "2023-09-27", "title": "자가면역 CD19 CAR-T 임상 등록", "text": "NCT06056921이 초기 임상으로 등록됐다.", "kind": "임상 등록", "url": "https://clinicaltrials.gov/study/NCT06056921", "source": "ClinicalTrials.gov" },
      { "date": "2025-12-24", "title": "circRNA 생체 내 CAR-T 시험 시작", "text": "NCT07322718이 초기 1상으로 등록됐다.", "kind": "임상 단계", "url": "https://clinicaltrials.gov/study/NCT07322718", "source": "ClinicalTrials.gov" },
      { "date": "2026-04-07", "title": "mRNA-LNP 생체 내 CAR-T 시험 시작", "text": "NCT07629596이 초기 1상으로 등록됐다.", "kind": "임상 단계", "url": "https://clinicaltrials.gov/study/NCT07629596", "source": "ClinicalTrials.gov" }
    ],
    "sources": [
      { "type": "임상시험 등록", "publisher": "ClinicalTrials.gov", "title": "CD19 CAR-T for autoimmune diseases — NCT06056921", "date": "갱신 확인 2026-08-21", "url": "https://clinicaltrials.gov/study/NCT06056921" },
      { "type": "임상시험 등록", "publisher": "ClinicalTrials.gov", "title": "In-vivo circRNA CD19 CAR-T — NCT07322718", "date": "갱신 확인 2026-08-21", "url": "https://clinicaltrials.gov/study/NCT07322718" },
      { "type": "임상시험 등록", "publisher": "ClinicalTrials.gov", "title": "mRNA-LNP in-vivo CAR-T — NCT07629596", "date": "갱신 확인 2026-08-21", "url": "https://clinicaltrials.gov/study/NCT07629596" },
      { "type": "임상시험 등록", "publisher": "ClinicalTrials.gov", "title": "BCMA CAR-T for autoimmune diseases — NCT07085676", "date": "갱신 2026-05-06", "url": "https://clinicaltrials.gov/study/NCT07085676" }
    ]
  },
  {
    "id": "grid-forming-inverters",
    "name": "계통형성 인버터",
    "nameEn": "Grid-forming inverters",
    "category": "에너지·전력",
    "status": "현장 실증",
    "statusKey": "field",
    "trajectory": "advance",
    "trajectoryLabel": "재생에너지 설비의 계통 안정화 실증",
    "verifiedAt": "2026-08-21",
    "summary": "전력망의 전압과 주파수를 외부 기준에 수동 추종하지 않고 스스로 형성하도록 제어하는 전력전자 기술이다. 인버터 기반 재생에너지 비중이 높아질수록 중요하지만 보호계전, 고장전류, 상호작용, 표준 시험이 함께 해결돼야 한다.",
    "currentState": "NREL·GE가 Type-3 풍력터빈의 계통형성 운전을 실증했으며, 다양한 인버터·전력망 조건으로 확장 검증 중인 단계",
    "access": "전력망 연구설비·유틸리티 실증·일부 상용 제어",
    "latest": { "date": "2022-01-14", "title": "풍력터빈 계통형성 모드의 실증 결과 공개", "text": "NREL과 GE는 Type-3 풍력터빈이 계통형성 모드로 기본 계통 안정화 기능을 제공하는 첫 사례를 보고했다. 전체 전력망 적용을 입증한 것은 아니다.", "source": "NREL", "url": "https://www.nrel.gov/news/detail/program/2022/landmark-demonstration-shows-wind-turbine-can-provide-fundamental-grid-stability" },
    "next": { "date": "지속 확인", "text": "대규모 다중 공급사 계통의 상호작용, 고장 관통·보호계전, 블랙스타트와 실제 운전 가동률" },
    "constraints": ["다중 인버터 제어 상호작용과 진동", "제한된 고장전류와 기존 보호계전 부조화", "공통 성능 정의·시험·모델 검증 부족", "기존 동기기와 혼합 운전 전환 절차"],
    "unknowns": ["다중 공급사 대규모 계통의 안정 한계", "현장 고장 시 보호 협조 성능", "추가 하드웨어·제어 비용과 편익"],
    "dimensions": [
      { "label": "제어", "state": "confirmed", "stateLabel": "실증", "value": "전압·주파수 기준 형성", "note": "NREL·GE 실증" },
      { "label": "풍력", "state": "confirmed", "stateLabel": "현장 시험", "value": "Type-3 터빈 적용", "note": "제한 시스템" },
      { "label": "보호", "state": "progress", "stateLabel": "검증 중", "value": "고장전류·계전 협조", "note": "계통별 차이" },
      { "label": "상호운용", "state": "unknown", "stateLabel": "미확인", "value": "다중 공급사 대규모 운전", "note": "공통 검증 필요" },
      { "label": "상용 운영", "state": "progress", "stateLabel": "부분 도입", "value": "설비별 제어 적용", "note": "전체 계통과 구분" }
    ],
    "facts": [
      { "value": "TYPE-3", "label": "실증 풍력터빈 유형", "note": "NREL·GE" },
      { "value": "FIELD TEST", "label": "검증 수준", "note": "전체 계통 일반화 아님" },
      { "value": "GRID REFERENCE", "label": "핵심 역할", "note": "전압·주파수 기준 형성" }
    ],
    "timeline": [
      { "date": "2022-01-14", "title": "풍력 계통형성 실증 공개", "text": "Type-3 풍력터빈의 계통형성 운전이 현장에서 시연됐다.", "kind": "현장 실증", "url": "https://www.nrel.gov/news/detail/program/2022/landmark-demonstration-shows-wind-turbine-can-provide-fundamental-grid-stability", "source": "NREL" },
      { "date": "2022-10-11", "title": "수동 동기화 방식 연구 공개", "text": "주파수 측정에 의존하지 않는 계통형성 인버터 동기화 방식이 발표됐다.", "kind": "연구", "url": "https://research-hub.nrel.gov/en/publications/universal-passive-synchronization-method-for-grid-forming-inverte/", "source": "NREL" }
    ],
    "sources": [
      { "type": "정부 연구기관 실증", "publisher": "NREL", "title": "Landmark demonstration shows wind turbine can provide fundamental grid stability", "date": "2022-01-14", "url": "https://www.nrel.gov/news/detail/program/2022/landmark-demonstration-shows-wind-turbine-can-provide-fundamental-grid-stability" },
      { "type": "연구 논문", "publisher": "NREL", "title": "Universal passive synchronization method for grid-forming inverters", "date": "2022-10-11", "url": "https://research-hub.nrel.gov/en/publications/universal-passive-synchronization-method-for-grid-forming-inverte/" }
    ]
  },
  {
    "id": "hydrogen-direct-reduced-iron",
    "name": "수소 직접환원철",
    "nameEn": "Hydrogen direct-reduced iron",
    "category": "기후·제조",
    "status": "대형 실증 준비",
    "statusKey": "field",
    "trajectory": "advance",
    "trajectoryLabel": "전기로·수전해 연계 실증",
    "verifiedAt": "2026-08-21",
    "summary": "석탄 코크스 대신 수소로 철광석의 산소를 제거해 직접환원철을 만들고 전기로에서 용해하는 저탄소 제철 경로다. 수소의 실제 배출집약도, 전력·광석 품질, 설비 전환, 제품 품질과 비용이 시스템 성패를 좌우한다.",
    "currentState": "미국 DOE가 고체산화물 수전해와 직접환원로를 통합하는 대형 실증에 1천만 달러를 지원한 파일럿·실증 확대 단계",
    "access": "제철사·수소 공급망·정부 실증 프로젝트",
    "latest": { "date": "2024-02-14", "title": "DOE가 수소 직접환원 통합 실증에 1천만 달러 지원", "text": "DOE는 고체산화물 수전해와 직접환원로 통합으로 연간 160만 톤 규모와 온실가스 90% 이상 감축 잠재력을 시험한다고 밝혔다. 이는 사업 목표이며 달성 결과가 아니다.", "source": "U.S. Department of Energy", "url": "https://www.energy.gov/cmei/fuels/articles/department-energy-announces-10-million-demonstrate-innovative-hydrogen-solution" },
    "next": { "date": "실증 운전 후", "text": "시간당 생산량, 환원율, 전력·수소 사용량, 제품 품질, 실제 수소 탄소집약도와 가동률" },
    "constraints": ["저탄소 수소의 대량·연속 공급", "고품위 철광석 펠릿 의존", "수전해·환원로·전기로의 통합 열관리", "기존 고로 자산 전환 비용과 제품 품질"],
    "unknowns": ["상업 규모의 톤당 총비용", "변동 전력에서의 연속 운전 성능", "광석 품위 범위와 제품 불순물"],
    "dimensions": [
      { "label": "환원 반응", "state": "confirmed", "stateLabel": "기술 확인", "value": "수소 기반 산소 제거", "note": "공정 원리" },
      { "label": "통합 실증", "state": "progress", "stateLabel": "준비", "value": "SOEC·직접환원로 연계", "note": "DOE 지원" },
      { "label": "감축률", "state": "progress", "stateLabel": "목표", "value": "90% 이상 잠재력", "note": "실측 결과 아님" },
      { "label": "수소 공급", "state": "unknown", "stateLabel": "미확인", "value": "저탄소·저비용 연속 공급", "note": "지역 의존" },
      { "label": "경제성", "state": "unknown", "stateLabel": "미확인", "value": "상업 규모 톤당 비용", "note": "실증 후 검증" }
    ],
    "facts": [
      { "value": "$10M", "label": "DOE 실증 지원 규모", "note": "2024-02-14" },
      { "value": "1.6 MT/Y", "label": "실증 프로젝트의 목표 연산 규모", "note": "달성 결과 아님" },
      { "value": "≥90%", "label": "온실가스 감축 잠재력 목표", "note": "전력·수소 조건 의존" }
    ],
    "timeline": [
      { "date": "2022-05-19", "title": "수소 플라스마 직접환원 프로젝트 공개", "text": "DOE가 연속 수소 플라스마 환원 공정 프로젝트를 기록했다.", "kind": "정부 프로젝트", "url": "https://www.energy.gov/nepa/articles/cx-026187-zero-emission-process-direct-reduction-iron-hydrogen-plasma-rotary-kiln", "source": "U.S. DOE" },
      { "date": "2024-02-14", "title": "SOEC·직접환원로 통합 실증 지원", "text": "대형 공정 통합 실증의 지원과 목표가 발표됐다.", "kind": "실증 지원", "url": "https://www.energy.gov/cmei/fuels/articles/department-energy-announces-10-million-demonstrate-innovative-hydrogen-solution", "source": "U.S. DOE" }
    ],
    "sources": [
      { "type": "정부기관 발표", "publisher": "U.S. Department of Energy", "title": "DOE announces $10 million hydrogen solution for clean steel production", "date": "2024-02-14", "url": "https://www.energy.gov/cmei/fuels/articles/department-energy-announces-10-million-demonstrate-innovative-hydrogen-solution" },
      { "type": "정부 프로젝트", "publisher": "U.S. Department of Energy", "title": "Zero-emission direct reduction of iron with hydrogen plasma rotary kiln", "date": "2022-05-19", "url": "https://www.energy.gov/nepa/articles/cx-026187-zero-emission-process-direct-reduction-iron-hydrogen-plasma-rotary-kiln" }
    ]
  },
  {
    "id": "backside-power-delivery",
    "name": "반도체 후면 전력 공급",
    "nameEn": "Backside power delivery network",
    "category": "반도체·제조",
    "status": "양산 전환",
    "statusKey": "field",
    "trajectory": "advance",
    "trajectoryLabel": "선단 공정 제품 적용 준비",
    "verifiedAt": "2026-08-21",
    "summary": "트랜지스터의 신호 배선과 전력 배선을 웨이퍼 앞·뒷면으로 분리해 배선 혼잡과 전압 강하를 줄이는 공정 통합 기술이다. 나노 TSV, 웨이퍼 박막화, 정렬, 열·기계 신뢰성, 설계 도구가 함께 성숙해야 한다.",
    "currentState": "Intel이 PowerVia 시험 칩에서 90% 초과 셀 이용률을 보고했고 Intel 18A에 RibbonFET과 함께 적용한다고 발표한 양산 전환 단계",
    "access": "선단 파운드리·EDA·공정 장비 공급망",
    "latest": { "date": "2023-06-05", "title": "PowerVia 시험 칩 성능과 셀 이용률 공개", "text": "Intel은 제품 유사 시험 칩에서 90% 초과 셀 이용률과 성능 개선을 보고했다. 고객 제품의 대량 양산 수율·신뢰성 자료와는 구분해야 한다.", "source": "Intel", "url": "https://newsroom.intel.com/client-computing/powervia-test-shows-industry-leading-performance" },
    "next": { "date": "18A 양산 확대 후", "text": "고객 제품 수율, 전력·주파수 이득, 후면 공정 결함률, 열·수명·수리 불가 위험" },
    "constraints": ["웨이퍼 박막화와 나노 TSV 정렬·결함", "후면 공정의 열·기계 응력", "전력망·신호망 공동 설계와 EDA 전환", "양산 수율·검사·패키징 통합"],
    "unknowns": ["다수 제품의 양산 수율", "설계별 실제 전력·성능 이득", "장기 열화와 후면 결함 검출성"],
    "dimensions": [
      { "label": "시험 칩", "state": "confirmed", "stateLabel": "검증", "value": "제품 유사 설계 실증", "note": "Intel 제공사 결과" },
      { "label": "셀 이용률", "state": "confirmed", "stateLabel": "90% 초과", "value": "PowerVia 시험 칩", "note": "제공사 수치" },
      { "label": "공정 통합", "state": "progress", "stateLabel": "18A 적용", "value": "RibbonFET과 결합", "note": "양산 범위 확인 필요" },
      { "label": "수율", "state": "unknown", "stateLabel": "미확인", "value": "다중 고객 양산 수율", "note": "시험 칩과 구분" },
      { "label": "신뢰성", "state": "unknown", "stateLabel": "미확인", "value": "열·기계 장기 수명", "note": "제품 추적 필요" }
    ],
    "facts": [
      { "value": ">90%", "label": "시험 칩 셀 이용률", "note": "Intel 제공사 수치" },
      { "value": "18A", "label": "PowerVia 적용 공정", "note": "RibbonFET과 결합" },
      { "value": "2NM+", "label": "imec 후면 전력 연구 대상", "note": "연구 로드맵" }
    ],
    "timeline": [
      { "date": "2022-06-14", "title": "imec 후면 전력 라우팅 실증", "text": "매립 전력 레일과 나노 TSV를 이용한 후면 전력 공급 통합 결과가 공개됐다.", "kind": "공정 연구", "url": "https://www.imec-int.com/en/press/imec-demonstrates-backside-power-delivery-buried-power-rails-back-and-frontside-routing", "source": "imec" },
      { "date": "2023-06-05", "title": "Intel PowerVia 시험 칩 공개", "text": "제품 유사 시험 칩의 셀 이용률과 공정 분리 방식이 발표됐다.", "kind": "시험 칩", "url": "https://newsroom.intel.com/client-computing/powervia-test-shows-industry-leading-performance", "source": "Intel" }
    ],
    "sources": [
      { "type": "연구기관 발표", "publisher": "imec", "title": "Backside power delivery with buried power rails and routing", "date": "2022-06-14", "url": "https://www.imec-int.com/en/press/imec-demonstrates-backside-power-delivery-buried-power-rails-back-and-frontside-routing" },
      { "type": "기업 기술 발표", "publisher": "Intel", "title": "PowerVia test shows industry-leading performance", "date": "2023-06-05", "url": "https://newsroom.intel.com/client-computing/powervia-test-shows-industry-leading-performance" },
      { "type": "공정 설명", "publisher": "Intel", "title": "Intel 18A process technology explained", "date": "확인 2026-08-21", "url": "https://newsroom.intel.com/de/intel-foundry/intel-18a-process-technology-simply-explained" }
    ]
  },
  {
    "id": "satellite-direct-to-device",
    "name": "위성-일반 스마트폰 직접 통신",
    "nameEn": "Satellite direct-to-device cellular broadband",
    "category": "우주·통신",
    "status": "초기 상용망 구축",
    "statusKey": "field",
    "trajectory": "mixed",
    "trajectoryLabel": "위성 배치 진전·연속 서비스 미확인",
    "verifiedAt": "2026-08-21",
    "summary": "대형 저궤도 위성이 기존 이동통신 주파수와 일반 스마트폰을 직접 연결해 음영 지역을 보완하는 기술이다. 위성 수, 주파수 승인, 지상 통신사 통합, 셀 용량, 간섭, 단말 전력과 발사 신뢰성이 함께 필요하다.",
    "currentState": "AST SpaceMobile이 차세대 BlueBird를 배치하고 있으나 2026년 3월 말 기준 SpaceMobile 서비스 매출은 없었고, BlueBird 7 손실도 공시된 구축 단계",
    "access": "통신사 파트너 지역의 단계적 시험·서비스",
    "latest": { "date": "2026-08-05", "title": "BlueBird 11~13 발사", "text": "AST는 차세대 위성 3기 발사를 발표했다. 발사는 서비스 커버리지·용량·가동률의 독립 검증과 동일하지 않다.", "source": "AST SpaceMobile", "url": "https://ast-science.com/next-gen-bluebird/" },
    "next": { "date": "2026년 하반기→", "text": "상용 서비스 개시 지역, 활성 가입자·트래픽, 연속 커버리지, 지연·속도 분포, 위성 고장률과 규제 승인" },
    "constraints": ["연속 커버리지에 필요한 위성 수와 발사 일정", "이동통신 주파수·국가별 규제·간섭 관리", "셀당 용량과 실내·가장자리 링크 예산", "대형 배열 배치·위성 고장과 자본집약적 확장"],
    "unknowns": ["실사용자의 지속 속도·지연·가용성", "국가별 서비스 개시 범위", "위성당 수명·고장률과 단위 경제성"],
    "dimensions": [
      { "label": "위성 배치", "state": "progress", "stateLabel": "확대 중", "value": "차세대 BlueBird 발사", "note": "가동 확인 별도" },
      { "label": "직접 연결", "state": "confirmed", "stateLabel": "시험 확인", "value": "일반 스마트폰 링크 시연", "note": "제공사 결과" },
      { "label": "연속성", "state": "unknown", "stateLabel": "미확인", "value": "상용 연속 커버리지", "note": "위성 수 의존" },
      { "label": "매출", "state": "unknown", "stateLabel": "미확인", "value": "2026-03-31 서비스 매출 없음", "note": "SEC 공시" },
      { "label": "발사 신뢰성", "state": "progress", "stateLabel": "혼재", "value": "BlueBird 7 손실 공시", "note": "후속 배치 추적" }
    ],
    "facts": [
      { "value": "~2,400 FT²", "label": "차세대 위성 배열 면적", "note": "AST 제공사 사양" },
      { "value": "0", "label": "2026-03-31까지 SpaceMobile 서비스 매출", "note": "SEC 10-Q" },
      { "value": "1 LOST", "label": "BlueBird 7 손실·궤도이탈", "note": "2026-04-19 SEC 공시" }
    ],
    "timeline": [
      { "date": "2026-02-10", "title": "BlueBird 6 배열 배치", "text": "최대 약 2,400제곱피트 배열의 차세대 위성이 배치됐다.", "kind": "운영", "url": "https://www.sec.gov/Archives/edgar/data/1780312/000119312526216950/asts-20260331.htm", "source": "SEC / AST SpaceMobile" },
      { "date": "2026-04-19", "title": "BlueBird 7 손실", "text": "회사는 위성이 임무 수행 없이 궤도 이탈했다고 분기 공시에 기록했다.", "kind": "운영 실패", "url": "https://www.sec.gov/Archives/edgar/data/1780312/000119312526216950/asts-20260331.htm", "source": "SEC" },
      { "date": "2026-08-05", "title": "BlueBird 11~13 발사", "text": "차세대 위성 3기가 추가 발사됐다.", "kind": "발사", "url": "https://ast-science.com/next-gen-bluebird/", "source": "AST SpaceMobile" }
    ],
    "sources": [
      { "type": "SEC 공시", "publisher": "AST SpaceMobile", "title": "Form 10-Q for quarter ended March 31, 2026", "date": "2026", "url": "https://www.sec.gov/Archives/edgar/data/1780312/000119312526216950/asts-20260331.htm" },
      { "type": "기업 임무 기록", "publisher": "AST SpaceMobile", "title": "Next generation BlueBird launches", "date": "갱신 2026-08-05", "url": "https://ast-science.com/next-gen-bluebird/" },
      { "type": "기업 기술 설명", "publisher": "AST SpaceMobile", "title": "BlueBird 1–5", "date": "확인 2026-08-21", "url": "https://ast-science.com/bluebird-1-5/" }
    ]
  }
);
...
window.TECHNOLOGY_RELATIONSHIPS = [
  ...
  {
    "from": "ai-protein-design",
    "to": "ai-scientific-discovery",
    "type": "가설에서 분자 설계로의 실행",
    "kind": "system",
    "strength": 2,
    "basis": "과학 에이전트가 표적·기전 가설을 만들 수 있고 단백질 설계 모델은 그 가설을 결합체 후보로 변환하지만, 양쪽 모두 실험 검증을 통과해야 한다.",
    "evidence": "연구 워크플로의 직접 계층 연결 — 가설 품질이 결합·기능 성공을 보장하지 않음"
  },
  {
    "from": "ai-materials-discovery",
    "to": "ai-scientific-discovery",
    "type": "후보 생성·자율 실험",
    "kind": "observed",
    "strength": 3,
    "basis": "GNoME의 계산 후보와 A-Lab의 로봇 합성은 모델 추론을 실험 선택·실행·관측으로 닫는 과학 발견 루프를 구성한다.",
    "evidence": "Nature의 GNoME·A-Lab 논문에서 확인되는 직접 시스템 연결"
  },
  {
    "from": "ai-materials-discovery",
    "to": "perovskite-tandem",
    "type": "흡수층·계면 소재 후보 탐색",
    "kind": "inferred",
    "strength": 1,
    "basis": "AI 소재 탐색은 탠덤 셀의 조성·계면 후보를 좁힐 수 있지만 장기 광·열 안정성과 모듈 제조성을 대신 입증하지 않는다.",
    "evidence": "탐색 도구 수준의 조건부 연결 — 소자·모듈 성능 전이 제한"
  },
  {
    "from": "car-t-autoimmune",
    "to": "in-vivo-gene-editing",
    "type": "생체 내 면역세포 재프로그래밍",
    "kind": "system",
    "strength": 2,
    "basis": "생체 내 CAR-T는 전달체로 환자 T세포를 체내에서 재프로그래밍하며, 전달 정확성·오프타깃·지속성이라는 생체 내 편집 계층의 병목을 공유한다.",
    "evidence": "ClinicalTrials.gov의 mRNA·circRNA 생체 내 CAR-T 임상 구조에서 확인되는 기술 의존"
  },
  {
    "from": "grid-forming-inverters",
    "to": "sodium-ion-battery",
    "type": "저장장치 전력변환·계통 안정화",
    "kind": "system",
    "strength": 2,
    "basis": "배터리는 에너지를 저장하고 계통형성 인버터는 전압·주파수 기준을 제공한다. 배터리 성능만으로 계통 제어의 안정성이 입증되지는 않는다.",
    "evidence": "저장 매체와 전력변환 제어의 직접 시스템 연결"
  },
  {
    "from": "grid-forming-inverters",
    "to": "perovskite-tandem",
    ...
    "kind": "system",
    "strength": 2,
    "basis": "태양광 발전 비중이 커질수록 인버터 기반 자원의 계통 안정화가 중요해지지만 소자 효율과 계통 안정성은 별도 성능 축이다.",
    "evidence": "발전 소자와 계통 접속 계층의 시스템 연결"
  },
  {
    "from": "hydrogen-direct-reduced-iron",
    "to": "grid-forming-inverters",
    "type": "저탄소 전력·수전해 운전",
    "kind": "inferred",
    "strength": 1,
    "basis": "수소 직접환원철의 배출과 비용은 대규모 수전해 전력에 의존하며, 인버터 기반 전원이 많은 계통에서는 안정적인 전력 공급 제어가 하류 공정 가동률에 영향을 준다.",
    "evidence": "전력 공급망의 조건부 연결 — 특정 제철 프로젝트의 직접 의존은 별도 확인 필요"
  },
  {
    "from": "backside-power-delivery",
    "to": "high-na-euv",
    "type": "선단 로직 공정 통합",
    "kind": "system",
    "strength": 2,
    "basis": "High-NA EUV는 미세 패턴을, 후면 전력 공급은 배선·전력 전달을 개선하며 선단 노드의 서로 다른 공정 병목을 동시에 다룬다.",
    "evidence": "리소그래피와 배선·전력 공정의 상보 관계 — 각 공정 수율은 별도 검증"
  },
  {
    "from": "backside-power-delivery",
    "to": "co-packaged-optics",
    "type": "AI 스위치 ASIC 전력·입출력 확장",
    "kind": "inferred",
    "strength": 1,
    "basis": "후면 전력은 ASIC 내부 전력망을, CPO는 패키지 경계의 광 입출력을 다룬다. 한쪽의 진전이 다른 쪽의 열·패키징 수율을 해결하지는 않는다.",
    "evidence": "AI 인프라 칩의 서로 다른 병목을 잇는 조건부 시스템 연결"
  },
  {
    "from": "satellite-direct-to-device",
    "to": "commercial-space-stations",
    "type": "발사·궤도·지상국 운영 인프라",
    "kind": "system",
    "strength": 1,
    "basis": "두 기술은 발사 서비스, 궤도 운영, 주파수·지상 통신 인프라를 공유하지만 위성 이동통신 성과가 상업 정거장 수요를 입증하지는 않는다.",
    "evidence": "공통 우주 운영 인프라 수준의 연결 — 제품·시장 성과는 독립"
  }
];
