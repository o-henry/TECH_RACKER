...
- APScheduler collects reviewed RSS feeds every 10 minutes, SEC filings every 30 minutes, ClinicalTrials.gov updates every 4 hours, and OpenAlex daily.
...
4. Add reviewed HTTPS feeds to `config/rss_feeds.yml`. Keep it empty rather than adding unverified feeds.
